<section id="aboutWeb"
    ...
    <div class="d-flex flex-column w-100">
        <h1 class="fw-bold fs-2 text-black">Nganjuk<span class="fw-medium font">.Ekraf</span></h1>
        ...
        <div class="d-flex flex-column flex-md-row gap-4 w-100 justify-content-between">
            <button class="btn btn-primary rounded-5 w-100 py-2">daftarkan Usaha Kreatifmu</button>
