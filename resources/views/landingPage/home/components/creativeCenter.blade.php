<section class="d-flex flex-column align-items-center py-5">
    ...
    <div class="progress w-25" style="height: 8px" role="progressbar" aria-label="Basic example" aria-valuenow="0"
    ...
    <div id="popupModal" class="popup-modal d-none">
        <div class="modal-content rounded-4 shadow p-5">
            ...
            <div class="d-flex flex-column align-items-center text-center gap-3">
                <img src="" id="modalImage" alt="Ilustrasi" class="img-fluid rounded"
                    style="max-height: 250px;">
                <h3 id="modalTitle" class="fw-semibold"></h3>
